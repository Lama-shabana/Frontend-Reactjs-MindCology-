            ...
            {patientInfo ?
                <div>
                    <div className="p-grid">
                        ...
                        <div className="p-col-3">
                            <Button label="حذف الحساب" className="primaryBtn" icon="pi pi-trash
" style={{
                                width: "12em",
                                height: "2.5em",
                                marginLeft: "1em",
                    ...
                    <Tabs defaultActiveKey="patientInfo" transition={false}>
                        <Tab eventKey="patientInfo" title="معلومات المريض" tabClassName={classes.tab}>
                            {patientInfoDisplay()}
                        </Tab>
...
export default connect(mapStateToProps, mapDispatchToProps)(ArabicPatientProfile);
